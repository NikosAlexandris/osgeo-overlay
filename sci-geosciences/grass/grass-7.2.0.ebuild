...
DESCRIPTION="Free & Open Source GIS suite for geospatial data management, analysis, image processing, graphics, maps production, spatial modeling, and visualization"
...
SLOT="0/7.2.0"
KEYWORDS="~amd64 ~x86"
IUSE="X blas bzip2 cxx fftw geos lapack liblas mysql netcdf nls odbc opencl opengl openmp png postgres readline sqlite threads tiff truetype"
...
src_configure() {
	...
	econf \
		...
		$(use_with png) \
		$(use_with postgres) \
		--with-proj-includes="${ROOT}usr/include/" \
